...
def attack(char_name: str, char_class: str) -> str:
    """Генерирует количество нанесённого урона противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """Генерирует количество блокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Генерирует количество нанесенного урона специальным умением."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Выводит класс бойца и предлагает тренировку навыков."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор персонажа и вывод его характеристик."""
    approve_choice: str = ''
    char_class: str = ''
